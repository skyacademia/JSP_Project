	  ...
	  <div class="container">
	    <div class="input-form-backgroud row">
			...
			<div class = "input-form col-md-6 mt-5 mx-auto my-auto">
				...
				<form class = "validation-form" method="post" name = "fr" action="<%= request.getContextPath()%>/edit_Member_Action.jsp" novalidate enctype="multipart/form-data">
					<div class = "mb-3">
					...
					<div class = "mb-3">
						...
						<input type="text" class = "form-control" value="<%=Skill%>" id="Skill" name="Skill" maxlength="45" required>
					</div>
					<div class = "mb-3">
