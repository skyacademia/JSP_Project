...
"디자이너7명, 기획1명, 아트디렉터1명으로 구성된 홈페이지제작, 웹디자인, 편집디자인,로고디자인,웹에이전시입니다.',"KAKAO","pimg1.png");
...
문의사항이 있으시면 메시지 남겨주세요~","KAKAO","pimg2.png");
...
파이썬 셀레니움을 활용한 웹브라우저 기반 실시간 데이터 수집, 웹사이트 내 반복적 업무 수행 매크로 제작","테슬라",default);
